...
public class AuthAppRepository {
    ...
    public void sendPasswordReset(String email){
        firebaseAuth.sendPasswordResetEmail(email).addOnCompleteListener(task -> {
            if (task.isSuccessful()){
                Toast.makeText(application, "Permintaan ganti kata sandi telah dikirim ke email", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(application, "Email belum terdaftar", Toast.LENGTH_SHORT).show();
            }
        });
    }
